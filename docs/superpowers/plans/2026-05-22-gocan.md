...
**Spec：** `docs/superpowers/specs/2026-05-22-gocan-design.md`
...
func lookupChannel(name string) (gocan.Channel, bool) {
    switch name {
    case "USBBus1":  return gocan.USBBus1, true
    case "USBBus2":  return gocan.USBBus2, true
    case "USBBus3":  return gocan.USBBus3, true
    case "USBBus4":  return gocan.USBBus4, true
    case "USBBus5":  return gocan.USBBus5, true
    case "USBBus6":  return gocan.USBBus6, true
    case "USBBus7":  return gocan.USBBus7, true
    case "USBBus8":  return gocan.USBBus8, true
    case "USBBus9":  return gocan.USBBus9, true
    case "USBBus10": return gocan.USBBus10, true
    case "USBBus11": return gocan.USBBus11, true
    case "USBBus12": return gocan.USBBus12, true
    case "USBBus13": return gocan.USBBus13, true
    case "USBBus14": return gocan.USBBus14, true
    case "USBBus15": return gocan.USBBus15, true
    case "USBBus16": return gocan.USBBus16, true
    }
    return 0, false
}
```
